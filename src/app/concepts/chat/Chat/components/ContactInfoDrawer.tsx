...
import type { ChatState, ChatAction } from '../store/chatStore'
...
const ContactInfoDrawer = () => {
    const contactInfoDrawer = useChatStore((state: ChatState) => state.contactInfoDrawer)
    const setContactInfoDrawer = useChatStore(
        (state: ChatState & ChatAction) => state.setContactInfoDrawer
    )
